...
export const FieldHelper: Record<FieldNameType, string> = {
  q: 'Search term',
  isHighlight: `Selected works of art from The Met Museum's permanent collection representing different cultures and time periods`,
  title: 'Specifically searching against the title field for objects',
  tags: 'Specifically searching against the subject keyword tags field for objects',
